...
export default async function BoardArticleDetailPage({ params }) {
  ...
  return (
    <div className="bg-[#f7f4d7]/60">
      <div className="screen-padding section mx-auto flex w-full max-w-4xl flex-col gap-6 py-10">
        ...
        <article className="space-y-6 rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm">
          ...
          <div className="flex items-center justify-between border-t border-neutral-100 pt-4 text-sm text-neutral-500">
            ...
            <BoardDetailActions boardSlug={board?.slug ?? slug} articleId={article.id} />
          </div>
        </article>
      </div>
    </div>
