      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-3xl border border-neutral-200 bg-white/90 p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <p className="text-sm font-medium text-neutral-700">대표 이미지</p>
            {form.imageUrl ? (
              <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-50">
                <img src={form.imageUrl} alt="대표 이미지" className="h-48 w-full object-cover" />
              </div>
            ) : (
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={(event) => {
                  ...
                  event.target.value = '';
                  uploadAndSetField(file, 'imageUrl');
                }}
              />
              <button
                type="button"
              ...
              >
                {uploadingField === 'imageUrl' ? '업로드 중...' : '이미지 선택'}
              </button>
              {form.imageUrl && (
                <button
                  type="button"
