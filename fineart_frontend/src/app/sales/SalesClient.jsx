...
const MATERIAL_OPTIONS = ['유화', '아크릴', '수채', '혼합재료'];
const PRICE_BUCKETS = [
  { label: '~30만', min: 0, max: 300_000 },
  { label: '30~50만', min: 300_000, max: 500_000 },
  { label: '50~100만', min: 500_000, max: 1_000_000 },
  { label: '100만~', min: 1_000_000, max: undefined },
];
const PAGE_SIZE = 9;
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-neutral-500">
                오픈갤러리형 필터를 활용해 원하는 작품을 빠르게 찾아보세요. 테마, 사이즈, 재질, 가격 그리고 렌탈 가능 여부까지 한 번에 비교할 수 있습니다.
              </p>
            </div>
            <button
              type="button"
